...
const GLfloat BACKCOLOR[ ] = { 0.0, 0.0, 0.0, 1. };


// line width for the axes:

const GLfloat AXES_WIDTH   = { 9. };
...
Display( )
{
	...
	*/
	...
	Pattern->SetUniformVariable("uColor", 0.5, 0.5, 0.5);
	...
	if (fragAnimation)
	{
		//Pattern->SetUniformVariable("uDs", Ds * (float)(sin(2. * M_PI * Time)));
		//Pattern->SetUniformVariable("uDt", Dt * (float)(cos(2. * M_PI * Time)));
		Pattern->SetUniformVariable("uRadius", (float)(5. + 5. * sin(2. * M_PI * Time)));
	}
    ...
    glLoadIdentity();
    glColor3f(0., 1., 1.);
    DoRasterString(1., 1., 1., "Aman Pandita Project5----Shaders");
