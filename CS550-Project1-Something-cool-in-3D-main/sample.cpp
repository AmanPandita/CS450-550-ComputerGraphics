...
InitLists( )
{
	...
	glNewList( BoxList, GL_COMPILE );
		...
		//baseofstructure
			...
			glColor3f( 0.7, 0.7, 0.7 );//grey
				...
				glNormal3f(0., -1., 0.);
					glVertex3f( -dx, -dy*0.5,  dz);
					glVertex3f( -dx, -dy*0.5, -dz );
					glVertex3f(  dx, -dy*0.5, -dz );
					glVertex3f(  dx, -dy*0.5,  dz );


			glColor3f( 0.7, 1, 0.7 );//lightgreen
			...
			glColor3f( 0.7, 0.7, 1 );//lightpurple
			...
			//post1
				glNormal3f(0., -1., 0.);
					glVertex3f( dx, -dy*0.5, dz);
					glVertex3f( dx*0.9, -dy*0.5, dz );
					glVertex3f( dx*0.9, -dy*-0.2, dz );
					glVertex3f(  dx, -dy*-0.2, dz );

				glNormal3f(0., -1., 0.);
					glVertex3f( dx, -dy*0.5, dz*0.9);
					glVertex3f( dx, -dy*0.5, dz);
					glVertex3f( dx, -dy*-0.2, dz);
					glVertex3f( dx, -dy*-0.2, dz*0.9);
	...
	//slantingplatform
			...
			glColor3f(0,1.0,1.0);	
				...
				// 	glVertex3f( dx, -dy, dz*1.5);
				// 	glVertex3f( -dx, -dy, dz*1.5);
				// 	glVertex3f( -dx, dy*-0.5, dz);
				// 	glVertex3f( dx, dy*-0.5, dz);

				glNormal3f(0., 0., 1.);
					glVertex3f( -dx, -dy*0.5,  dz + 0.2);
					glVertex3f( dx, -dy*0.5, dz + 0.2);
					glVertex3f( dx, -dy*0.75, dz+0.2);
					glVertex3f( -dx, -dy*0.75,  dz+0.2);

				glNormal3f(0., 0., 1.);
					glVertex3f( -dx, -dy*0.75,  dz + 0.4);
					glVertex3f( dx, -dy*0.75, dz + 0.4);
					glVertex3f( dx, -dy, dz+0.4);
					glVertex3f( -dx, -dy,  dz+0.4);
